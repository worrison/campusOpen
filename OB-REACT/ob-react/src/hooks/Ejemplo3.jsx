 ...
 * Ejemplo Hooks
 * useState()
 * useContest()  => Se usa para trabajar con datos, para poder pasarselo a componentes inferiores
 */
...
export default function MiComponenteConContexto() {
  ...
  <miContexto.Provider value={sessionData}>
    ...
    {/**Además, si se actualiza, los componentes de aqui, tambien lo actualizaran */}
    <h1>Ejemlo de useState( y useContext()***)</h1>
